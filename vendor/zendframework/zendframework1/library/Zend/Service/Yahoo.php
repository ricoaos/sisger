...
class Zend_Service_Yahoo
{
    ...
    protected function _validateInlinkDataSearch(array $options)
    {
        ...
        if (isset($options['results']) && ! $between->setMin(1)
            ->setMax(100)
        ...
        if (isset($options['start']) && ! $between->setMin(1)
            ->setMax(1000)
    ...
    protected function _validateLocalSearch(array $options)
    {
        ...
        if (isset($options['longitude']) && ! $between->setMin(- 90)
            ->setMax(90)
        ...
        if (isset($options['latitude']) && ! $between->setMin(- 180)
            ->setMax(180)
