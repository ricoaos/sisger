...
class Zend_Service_WindowsAzure_Management_Client
{
    ...
    public function getOperationStatus($requestId = '')
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($result)) {
                return new Zend_Service_WindowsAzure_Management_OperationStatusInstance((string) $result->ID, (string) $result->Status, ($result->Error ? (string) $result->Error->Code : ''), ($result->Error ? (string) $result->Error->Message : ''));
            }
            return null;
        } else {
    ...
    public function listSubscriptionOperations($startTime, $endTime, $objectIdFilter = null, $operationResultFilter = null, $continuationToken = null)
    {
        ...
        if ($response->isSuccessful()) {
            ...
            foreach ($xmlOperations as $xmlOperation) {
                ...
                $operation = new Zend_Service_WindowsAzure_Management_SubscriptionOperationInstance($xmlOperation->OperationId, $xmlOperation->OperationObjectId, $xmlOperation->OperationName, array(), (array) $xmlOperation->OperationCaller, (array) $xmlOperation->OperationStatus);
    ...
    public function createBlobClientForService($serviceName, Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy = null)
    {
        ...
        return new Zend_Service_WindowsAzure_Storage_Blob(Zend_Service_WindowsAzure_Storage::URL_CLOUD_BLOB, $serviceName, $storageKeys[0], false, $retryPolicy);
    }
    ...
    public function createTableClientForService($serviceName, Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy = null)
    {
        ...
        return new Zend_Service_WindowsAzure_Storage_Table(Zend_Service_WindowsAzure_Storage::URL_CLOUD_TABLE, $serviceName, $storageKeys[0], false, $retryPolicy);
    }
    ...
    public function createQueueClientForService($serviceName, Zend_Service_WindowsAzure_RetryPolicy_RetryPolicyAbstract $retryPolicy = null)
    {
        ...
        return new Zend_Service_WindowsAzure_Storage_Queue(Zend_Service_WindowsAzure_Storage::URL_CLOUD_QUEUE, $serviceName, $storageKeys[0], false, $retryPolicy);
    }
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($xmlServices)) {
                for ($i = 0; $i < count($xmlServices); $i ++) {
                    $services[] = new Zend_Service_WindowsAzure_Management_StorageServiceInstance((string) $xmlServices[$i]->Url, (string) $xmlServices[$i]->ServiceName);
                }
            }
            return $services;
        } else {
     ...
     * These properties include: the address, description, and
    ...
    public function getStorageAccountProperties($serviceName)
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($xmlService)) {
                ...
                return new Zend_Service_WindowsAzure_Management_StorageServiceInstance((string) $xmlService->Url, (string) $xmlService->ServiceName, (string) $xmlService->StorageServiceProperties->Description, (string) $xmlService->StorageServiceProperties->AffinityGroup, (string) $xmlService->StorageServiceProperties->Location, (string) $xmlService->StorageServiceProperties->Label);
            }
            return null;
        } else {
            require_once 'Zend/Service/WindowsAzure/Management/Exception.php';
    ...
    public function regenerateStorageAccountKey($serviceName, $key = 'primary')
    {
        ...
        $response = $this->_performRequest(self::OP_STORAGE_ACCOUNTS . '/' . $serviceName . '/keys', '?action=regenerate', Zend_Http_Client::POST, array(
    ...
    public function listHostedServices()
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($xmlServices)) {
                ...
                for ($i = 0; $i < count($xmlServices); $i ++) {
                    $services[] = new Zend_Service_WindowsAzure_Management_HostedServiceInstance((string) $xmlServices[$i]->Url, (string) $xmlServices[$i]->ServiceName);
                }
            }
            return $services;
        } else {
    ...
    public function createHostedService($serviceName, $label, $description = '', $location = null, $affinityGroup = null)
    {
        ...
        $locationOrAffinityGroup = is_null($location) ? '<AffinityGroup>' . $affinityGroup . '</AffinityGroup>' : '<Location>' . $location . '</Location>';
        
        $response = $this->_performRequest(self::OP_HOSTED_SERVICES, '', Zend_Http_Client::POST, array(
    ...
    public function updateHostedService($serviceName, $label, $description = '')
    {
        ...
        $response = $this->_performRequest(self::OP_HOSTED_SERVICES . '/' . $serviceName, '', Zend_Http_Client::PUT, array(
            'Content-Type' => 'application/xml; charset=utf-8'
     ...
     * for the specified hosted service.
     * These properties include the service
    ...
    public function getHostedServiceProperties($serviceName)
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($xmlService)) {
                ...
                $returnValue = new Zend_Service_WindowsAzure_Management_HostedServiceInstance((string) $xmlService->Url, (string) $xmlService->ServiceName, (string) $xmlService->HostedServiceProperties->Description, (string) $xmlService->HostedServiceProperties->AffinityGroup, (string) $xmlService->HostedServiceProperties->Location, (string) $xmlService->HostedServiceProperties->Label);
                ...
                if (count($xmlService->Deployments->Deployment) > 1) {
                    ...
                    $xmlServices = array(
                        $xmlService->Deployments->Deployment
                    );
                }
    ...
    public function createDeployment($serviceName, $deploymentSlot, $name, $label, $packageUrl, $configuration, $startDeployment = false, $treatWarningsAsErrors = false)
    {
        ...
        $response = $this->_performRequest($operationUrl, '', Zend_Http_Client::POST, array(
            'Content-Type' => 'application/xml; charset=utf-8'
    ...
    {
        $response = $this->_performRequest($operationUrl . '/', '?comp=status', Zend_Http_Client::POST, array(
            'Content-Type' => 'application/xml; charset=utf-8'
    ...
    protected function _convertXmlElementToDeploymentInstance($xmlService)
    {
        if (! is_null($xmlService)) {
            ...
            $returnValue = new Zend_Service_WindowsAzure_Management_DeploymentInstance((string) $xmlService->Name, (string) $xmlService->DeploymentSlot, (string) $xmlService->PrivateID, (string) $xmlService->Label, (string) $xmlService->Url, (string) $xmlService->Configuration, (string) $xmlService->Status, (string) $xmlService->UpgradeStatus, (string) $xmlService->UpgradeType, (string) $xmlService->CurrentUpgradeDomainState, (string) $xmlService->CurrentUpgradeDomain, (string) $xmlService->UpgradeDomainCount);
            ...
            if ($xmlService->RoleInstanceList && $xmlService->RoleInstanceList->RoleInstance) {
                ...
                if (count($xmlService->RoleInstanceList->RoleInstance) == 1) {
                    $xmlRoleInstances = array(
                        $xmlService->RoleInstanceList->RoleInstance
                    );
                }
     ...
     *            The role name
     * @param string|array $instanceCount
     *            The instance count
     * @throws Zend_Service_WindowsAzure_Management_Exception
     */
    ...
    protected function _configureDeployment($operationUrl, $configuration)
    {
        ...
        $response = $this->_performRequest($operationUrl . '/', '?comp=config', Zend_Http_Client::POST, array(
            'Content-Type' => 'application/xml; charset=utf-8'
    ...
    protected function _upgradeDeployment($operationUrl, $label, $packageUrl, $configuration, $mode, $roleToUpgrade)
    {
        ...
        $response = $this->_performRequest($operationUrl . '/', '?comp=upgrade', Zend_Http_Client::POST, array(
            'Content-Type' => 'application/xml; charset=utf-8'
    ...
    {
        $response = $this->_performRequest($operationUrl . '/', '?comp=walkupgradedomain', Zend_Http_Client::POST, array(
            'Content-Type' => 'application/xml; charset=utf-8'
    ...
    public function listCertificates($serviceName)
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($xmlServices)) {
                ...
                for ($i = 0; $i < count($xmlServices); $i ++) {
                    $services[] = new Zend_Service_WindowsAzure_Management_CertificateInstance((string) $xmlServices[$i]->CertificateUrl, (string) $xmlServices[$i]->Thumbprint, (string) $xmlServices[$i]->ThumbprintAlgorithm, (string) $xmlServices[$i]->Data);
                }
            }
            return $services;
        } else {
     ...
     *
     * @param string $serviceName|$certificateUrl
     *            The service name -or- the certificate URL
    ...
    public function getCertificate($serviceName, $algorithm = '', $thumbprint = '')
    {
        ...
        if ($response->isSuccessful()) {
            ...
            return new Zend_Service_WindowsAzure_Management_CertificateInstance($this->getBaseUrl() . $operationUrl, $algorithm, $thumbprint, (string) $result->Data);
        } else {
            require_once 'Zend/Service/WindowsAzure/Management/Exception.php';
            throw new Zend_Service_WindowsAzure_Management_Exception($this->_getErrorMessage($response, 'Resource could not be accessed.'));
        }
    ...
    public function listAffinityGroups()
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($xmlServices)) {
                ...
                for ($i = 0; $i < count($xmlServices); $i ++) {
                    $services[] = new Zend_Service_WindowsAzure_Management_AffinityGroupInstance((string) $xmlServices[$i]->Name, (string) $xmlServices[$i]->Label, (string) $xmlServices[$i]->Description, (string) $xmlServices[$i]->Location);
                }
            }
            return $services;
        } else {
    ...
    public function createAffinityGroup($name, $label, $description = '', $location = '')
    {
        ...
        $response = $this->_performRequest(self::OP_AFFINITYGROUPS, '', Zend_Http_Client::POST, array(
            'Content-Type' => 'application/xml; charset=utf-8'
    ...
    public function updateAffinityGroup($name, $label, $description = '')
    {
        ...
        $response = $this->_performRequest(self::OP_AFFINITYGROUPS . '/' . $name, '', Zend_Http_Client::PUT, array(
            'Content-Type' => 'application/xml; charset=utf-8'
    ...
    public function deleteAffinityGroup($name)
    {
        ...
        $response = $this->_performRequest(self::OP_AFFINITYGROUPS . '/' . $name, '', Zend_Http_Client::DELETE);
    ...
    public function getAffinityGroupProperties($affinityGroupName)
    {
        ...
        if ($response->isSuccessful()) {
            ...
            $affinityGroup = new Zend_Service_WindowsAzure_Management_AffinityGroupInstance($affinityGroupName, (string) $result->Label, (string) $result->Description, (string) $result->Location);
            ...
            if (count($result->HostedServices->HostedService) > 1) {
                ...
                $xmlService = array(
                    $result->HostedServices->HostedService
                );
            }
            ...
            if (count($result->StorageServices->StorageService) > 1) {
                ...
                $xmlService = array(
                    $result->StorageServices->StorageService
                );
            }
    ...
    public function listLocations()
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($xmlServices)) {
                ...
                for ($i = 0; $i < count($xmlServices); $i ++) {
                    $services[] = new Zend_Service_WindowsAzure_Management_LocationInstance((string) $xmlServices[$i]->Name);
                }
            }
            return $services;
        } else {
     ...
     * that are currently available in Windows Azure.
     * The 2010-10-28 version of List Operating
    ...
    public function listOperatingSystems()
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($xmlServices)) {
                ...
                for ($i = 0; $i < count($xmlServices); $i ++) {
                    $services[] = new Zend_Service_WindowsAzure_Management_OperatingSystemInstance((string) $xmlServices[$i]->Version, (string) $xmlServices[$i]->Label, ((string) $xmlServices[$i]->IsDefault == 'true'), ((string) $xmlServices[$i]->IsActive == 'true'), (string) $xmlServices[$i]->Family, (string) $xmlServices[$i]->FamilyLabel);
                }
            }
            return $services;
        } else {
     ...
     * Currently Windows Azure supports two operating
    ...
    public function listOperatingSystemFamilies()
    {
        ...
        if ($response->isSuccessful()) {
            ...
            if (! is_null($xmlServices)) {
                ...
                for ($i = 0; $i < count($xmlServices); $i ++) {
                    $services[] = new Zend_Service_WindowsAzure_Management_OperatingSystemFamilyInstance((string) $xmlServices[$i]->Name, (string) $xmlServices[$i]->Label);
                    ...
                    if (count($xmlServices[$i]->OperatingSystems->OperatingSystem) > 1) {
                        ...
                        $xmlOperatingSystems = array(
                            $xmlServices[$i]->OperatingSystems->OperatingSystem
                        );
                    }
                    ...
                    if (! is_null($xmlOperatingSystems)) {
                        ...
                        for ($i = 0; $i < count($xmlOperatingSystems); $i ++) {
                            $operatingSystems[] = new Zend_Service_WindowsAzure_Management_OperatingSystemInstance((string) $xmlOperatingSystems[$i]->Version, (string) $xmlOperatingSystems[$i]->Label, ((string) $xmlOperatingSystems[$i]->IsDefault == 'true'), ((string) $xmlOperatingSystems[$i]->IsActive == 'true'), (string) $xmlServices[$i]->Name, (string) $xmlServices[$i]->Label);
                        }
                    }
