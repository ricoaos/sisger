...
class Zend_Tool_Project_Provider_DbTable extends Zend_Tool_Project_Provider_Abstract implements Zend_Tool_Framework_Provider_Pretendable
{
    ...
    public function create($name, $actualTableName, $module = null, $forceOverwrite = false)
    {
        ...
        if ($request->isPretend()) {
            $response->appendContent('Would create a DbTable at ' . $tableResource->getContext()
                ->getPath());
        } else {
            $response->appendContent('Creating a DbTable at ' . $tableResource->getContext()
                ->getPath());
     ...
     *            Whether should force overwriting previous classes generated
     * @return void
     */
    public function createFromDatabase($module = null, $forceOverwrite = false)
    {
        ...
        if ($this->_registry->getRequest()->isPretend()) {
            ...
            foreach ($tableResources as $tableResource) {
                $this->_registry->getResponse()->appendContent('Would create a DbTable at ' . $tableResource->getContext()
                    ->getPath());
            }
        } else {
            
            foreach ($tableResources as $tableResource) {
                $this->_registry->getResponse()->appendContent('Creating a DbTable at ' . $tableResource->getContext()
                    ->getPath());
                $tableResource->create();
            }
