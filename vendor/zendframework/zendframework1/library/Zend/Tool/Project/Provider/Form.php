...
class Zend_Tool_Project_Provider_Form extends Zend_Tool_Project_Provider_Abstract
{
    ...
    public function enable($module = null)
    {
        ...
        if ($formDirectoryResource->isEnabled()) {
            ...
            if ($this->_registry->getRequest()->isPretend()) {
                $this->_registry->getResponse()->appendContent('Would enable forms directory at ' . $formDirectoryResource->getContext()
                    ->getPath());
            } else {
                $this->_registry->getResponse()->appendContent('Enabling forms directory at ' . $formDirectoryResource->getContext()
                    ->getPath());
    ...
    public function create($name, $module = null)
    {
        ...
        if ($this->_registry->getRequest()->isPretend()) {
            ...
            $this->_registry->getResponse()->appendContent('Would create a form at ' . $formResource->getContext()
                ->getPath());
            
            if ($testFormResource) {
                $this->_registry->getResponse()->appendContent('Would create a form test file at ' . $testFormResource->getContext()
                    ->getPath());
            }
        } else {
            
            $this->_registry->getResponse()->appendContent('Creating a form at ' . $formResource->getContext()
                ->getPath());
            $formResource->create();
