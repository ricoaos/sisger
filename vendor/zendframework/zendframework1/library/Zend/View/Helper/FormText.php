...
class Zend_View_Helper_FormText extends Zend_View_Helper_FormElement
{
    ...
    public function formText($name, $value = null, $attribs = null)
    {
        ...
        $xhtml = '<input type="text"' . ' name="' . $this->view->escape($name) . '"' . ' id="' . $this->view->escape($id) . '"' . ' value="' . $this->view->escape($value) . '"' . $disabled . $this->_htmlAttribs($attribs) . $this->getClosingBracket();
