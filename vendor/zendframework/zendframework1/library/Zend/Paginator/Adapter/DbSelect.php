...
class Zend_Paginator_Adapter_DbSelect implements Zend_Paginator_Adapter_Interface
{
     ...
     * This value will remain constant for
    ...
    public function getCountSelect()
    {
        ...
        if (! empty($unionParts)) {
             ...
             */
            if (($isDistinct && ((count($columnParts) == 1 && $columnParts[0][1] == Zend_Db_Select::SQL_WILDCARD) || count($columnParts) > 1)) || count($groupParts) > 1 || ! empty($havingParts)) {
